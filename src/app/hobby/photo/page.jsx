...
export default function PhotoHobbyPage() {
  ...
  return (
    <>
      ...
      <h4>じゃあ，ちゃんとしたカメラの利点は何やねん？</h4>
      <p>
        やっぱり，感度（明るさ）とか，絞り（ピントの合わせ方）とか，シャッタースピードを詳細にコントロールできるってとこやと思います．例えば，背景をわざとぼやかしてる写真とかって，綺麗ですよねぇ．そういうのはだいたい，この３箇所を調節して撮影してると思います．
      </p>
    </>
  );
}